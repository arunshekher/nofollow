...
class nofollow_admin
{
	...
	public function config($ui)
	{
		...
		//Note: 'urls' will be returned as $_POST['x_nofollow_url']. ie. x_{PLUGIN_FOLDER}_{YOURFIELDKEY}
	...
	public function process($ui, $id=0)
	{
		...
		if(!empty($id) )
		{
			...
			if(!empty($data['x_nofollow_url']))
			{

				// Save the data in 'nofollow' plugin table. .
