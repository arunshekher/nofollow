...
<img src="http://www.e107.space/projects/nofollow/svg" alt="Mentions" width="128" height="128">
</div>
<ul class="list-unstyled">
	...
	<li>
		<p>
			<small>' . LAN_NOFOLLOW_INFO_MENU_SUPPORT_DEV_TEXT . '</small>
		</p>
	</li>
	<li class="text-center">
	...
	<li class="text-center">
		<p style="padding-top:10px;">
			<small>' . LAN_NOFOLLOW_INFO_MENU_SUPPORT_DEV_TEXT_SIGN . '</small>
		</p>
